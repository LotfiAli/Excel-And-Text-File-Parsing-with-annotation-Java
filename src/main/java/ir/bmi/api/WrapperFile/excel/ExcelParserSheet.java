...
//    private List<String> getHeaderProperty() throws BaseExcelParserException {
//        List<String> headers = new ArrayList<String>();
//        Object targetObject = Utility.getObjectFromField(metaDataObject.getField(), instance);
//        Field[] taFields = targetObject.getClass().getDeclaredFields();
//        for (Field feild : taFields) {
//            headers.add(feild.getName());
//        }
//        return headers;
//    }
//
//    private List<List<Object>> getBody2() {
//        List<List<Object>> resultList = new ArrayList<List<Object>>();
//        if (metaDataObject.getArray()) {
//
//        } else {
//
//        }
